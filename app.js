...
const data = {
    creators: [
        { title: "Melat", sub: "196 Followers", age: 21, city: "Addis Ababa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127750/images_32.jpg", isOnline: true },
        { title: "Selam", sub: "254 Followers", age: 23, city: "Hawassa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127761/c0925a4a731a3be6d8a120c0e265bb3f.jpg", isOnline: false },
        { title: "Hlina", sub: "388 Followers", age: 20, city: "Adama", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127759/1788171869754.jpg", isOnline: true },
        { title: "Tnsae", sub: "97 Followers", age: 22, city: "Addis Ababa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127756/images_29.jpg", isOnline: true },
        { title: "Nardos", sub: "104 Followers", age: 24, city: "Bahir Dar", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127753/20c2c1ae906b1aed619cd04af126ce32.jpg", isOnline: false },
        { title: "Senait", sub: "259 Followers", age: 19, city: "Bishoftu", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127752/telegram_logo.jpg", isOnline: true },
        { title: "Hawi", sub: "1.1k Followers", age: 25, city: "Mekelle", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127751/images_30.jpg", isOnline: false },
        { title: "Meklit", sub: "2k Followers", age: 22, city: "Addis Ababa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127751/images_38.jpg", isOnline: true },
        { title: "Tigst", sub: "580 Followers", age: 21, city: "Dire Dawa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127750/images_37.jpg", isOnline: true },
        { title: "Saron", sub: "2.1k Followers", age: 23, city: "Addis Ababa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127750/images_31.jpg", isOnline: false },
        { title: "Eden", sub: "93 Followers", age: 20, city: "Hawassa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127749/images_33.jpg", isOnline: true },
        { title: "Mahlet", sub: "654 Followers", age: 22, city: "Adama", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127749/images_36.jpg", isOnline: false },
        { title: "Hermela", sub: "159 Followers", age: 24, city: "Gondar", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127749/images_35.jpg", isOnline: true },
        { title: "Elnatan", sub: "908 Followers", age: 21, city: "Addis Ababa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127748/images_34.jpg", isOnline: true },
        { title: "Thion", sub: "790 Followers", age: 23, city: "Jimma", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127747/images_39.jpg", isOnline: false },
        { title: "Fikr", sub: "1.9k Followers", age: 22, city: "Addis Ababa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127745/images_40.jpg", isOnline: true },
        { title: "Sara", sub: "300 Followers", age: 20, city: "Bahir Dar", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127745/images_41.jpg", isOnline: false },
        { title: "Nardos", sub: "840 Followers", age: 21, city: "Hawassa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127743/images_42.jpg", isOnline: true },
        { title: "Mekdes", sub: "2.2k Followers", age: 25, city: "Addis Ababa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127742/83148274_590365711817756_1251195743274776584_n.jpg", isOnline: true },
        { title: "Tsion", sub: "2.6k Followers", age: 23, city: "Adama", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127741/images_43.jpg", isOnline: false },
        { title: "Beti", sub: "194 Followers", age: 21, city: "Addis Ababa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127750/images_32.jpg", isOnline: true },
        { title: "Hellen", sub: "632 Followers", age: 23, city: "Hawassa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127741/7584311.jpg", isOnline: false },
        { title: "Rahel", sub: "633 Followers", age: 20, city: "Adama", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127740/images_44.jpg", isOnline: true },
        { title: "Bethlehem", sub: "1.4k Followers", age: 22, city: "Addis Ababa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127740/images_45.jpg", isOnline: true },
        { title: "Eden", sub: "764 Followers", age: 24, city: "Bahir Dar", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127740/images_47.jpg", isOnline: false },
        { title: "Meron", sub: "951 Followers", age: 19, city: "Bishoftu", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127739/images_46.jpg", isOnline: true },
        { title: "Makiba", sub: "1.1k Followers", age: 25, city: "Mekelle", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127739/images_50.jpg", isOnline: false },
        { title: "Frehiwot", sub: "5k Followers", age: 22, city: "Addis Ababa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127739/images_49.jpg", isOnline: true },
        { title: "Martha", sub: "58 Followers", age: 21, city: "Dire Dawa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127738/images_48.jpg", isOnline: true },
        { title: "Yordanos", sub: "2.1k Followers", age: 23, city: "Addis Ababa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127738/36148884_258672284688860_5764975112105230336_n.jpg", isOnline: false },
        { title: "Feven", sub: "866 Followers", age: 20, city: "Hawassa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127738/images_51.jpg", isOnline: true },
        { title: "Ruth", sub: "1k Followers", age: 22, city: "Adama", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127735/images_52.jpg", isOnline: false },
        { title: "Yeabsra", sub: "120 Followers", age: 24, city: "Gondar", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127735/images_53.jpg", isOnline: true },
        { title: "Kidist", sub: "980 Followers", age: 21, city: "Addis Ababa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127735/images_54.jpg", isOnline: true },
        { title: "Feven", sub: "1.1 Followers", age: 23, city: "Jimma", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127735/images_55.jpg", isOnline: false },
        { title: "Solyana", sub: "1k Followers", age: 22, city: "Addis Ababa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127735/images_57.jpg", isOnline: true },
        { title: "Eldana", sub: "370 Followers", age: 20, city: "Bahir Dar", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127735/images_65.jpg", isOnline: false },
        { title: "Haimanot", sub: "986 Followers", age: 21, city: "Hawassa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127734/images_56.jpg", isOnline: true },
        { title: "Yordanos", sub: "1.2k Followers", age: 25, city: "Addis Ababa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127734/images_62.jpg", isOnline: true },
        { title: "Lidya", sub: "2k Followers", age: 23, city: "Adama", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127734/images_58.jpg", isOnline: false },
        { title: "Blen", sub: "865 Followers", age: 21, city: "Addis Ababa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127750/images_32.jpg", isOnline: true },
        { title: "Samrawit", sub: "759 Followers", age: 23, city: "Hawassa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127733/images_64.jpg", isOnline: false },
        { title: "Rahel", sub: "173 Followers", age: 20, city: "Adama", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127733/images_63.jpg", isOnline: true },
        { title: "Rediet", sub: "1.2k Followers", age: 22, city: "Addis Ababa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127732/images_61.jpg", isOnline: true },
        { title: "Kalkidan", sub: "307 Followers", age: 24, city: "Bahir Dar", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789127731/images_66.jpg", isOnline: false },
        { title: "Zema", sub: "905 Followers", age: 19, city: "Bishoftu", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789186861/1788171917150.jpg", isOnline: true },
        { title: "Maki", sub: "3.1k Followers", age: 25, city: "Mekelle", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789186856/1788171968874.jpg", isOnline: false },
        { title: "Bamlak", sub: "1.6k Followers", age: 22, city: "Addis Ababa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789186849/1788171991842.jpg", isOnline: true },
        { title: "Martha", sub: "643 Followers", age: 21, city: "Dire Dawa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789186848/1788172228887.jpg", isOnline: true },
        { title: "Azeb", sub: "3.1k Followers", age: 23, city: "Addis Ababa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789186848/1788172097789.jpg", isOnline: false },
        { title: "Bisrat", sub: "276 Followers", age: 20, city: "Hawassa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789186846/1788172115673.jpg", isOnline: true },
        { title: "Haset", sub: "982 Followers", age: 22, city: "Adama", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789186846/1788172122212.jpg", isOnline: false },
        { title: "Meaza", sub: "154 Followers", age: 24, city: "Gondar", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789186841/1788172194616.jpg", isOnline: true },
        { title: "Etsegenet", sub: "658 Followers", age: 21, city: "Addis Ababa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789186841/1788172319280.jpg", isOnline: true },
        { title: "Elsa", sub: "790 Followers", age: 23, city: "Jimma", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789186838/1788172420877.jpg", isOnline: false },
        { title: "Senait", sub: "1.2k Followers", age: 22, city: "Addis Ababa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789186837/1788172355452.jpg", isOnline: true },
        { title: "Rosa", sub: "390 Followers", age: 20, city: "Bahir Dar", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789186836/1788172373952.jpg", isOnline: false },
        { title: "Tzta", sub: "445 Followers", age: 21, city: "Hawassa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789186834/1788172387659.jpg", isOnline: true },
        { title: "Naomi", sub: "2k Followers", age: 25, city: "Addis Ababa", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789186832/1788172128809.jpg", isOnline: true },
        { title: "Marta", sub: "942 Followers", age: 23, city: "Adama", img: "https://res.cloudinary.com/hubpqmdc/image/upload/v1789186832/1788171906232.jpg", isOnline: false }
...
function openChatRoom(chatId) {
    ...
    header.innerHTML = `
        ...
        <img src="${chat.img}" style="width:40px; height:40px; border-radius:50%; object-fit:cover;">
...
function openModelCard(model) {
    ...
    sheet.innerHTML = `
        ...
        <div style="position:relative; margin-bottom:12px;">
            <img src="${model.img}" style="width:90px; height:90px; border-radius:50%; object-fit:cover; border:2px solid #b50d12;">
...
function openGroupCard(group) {
    ...
    sheet.innerHTML = `
        ...
        <img src="${group.img}" style="width:80px; height:80px; border-radius:16px; object-fit:cover; margin-bottom:12px; border:1px solid #282828;">
